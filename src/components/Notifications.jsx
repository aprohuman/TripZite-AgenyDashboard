...
const Notification = () => {
  ...
  return (
    <div className="relative w-full min-h-screen bg-white overflow-hidden">
      ...
      <div className="absolute top-0 left-0 w-1/6 h-1/6 md:h-[11rem] md:w-1/9 object-cover">
        <img
          src={curve1Image}
          alt="Curve 1"
      ...
      <div className="relative z-20 container mx-auto px-4 md:px-6 py-8 h-[90vh] flex flex-col md:flex-row justify-between md:gap-6">
        ...
        <div className="box-border w-full md:w-[28%] flex flex-col gap-4 md:gap-4">
          <button className="w-full py-3 bg-[#102728] text-white text-base md:text-lg rounded-lg shadow hover:scale-105 transition-transform">
          ...
          <button
            ...
            className="w-full py-3 bg-[#102728] text-white text-base md:text-lg rounded-lg shadow hover:scale-105 transition-transform"
          >
            Your Packages
          </button>
          <button
