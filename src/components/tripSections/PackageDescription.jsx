              ...
              {field.type === 'textarea' ? (
                <div className=" flex flex-col w-full">
                  <textarea
                    ...
                    className={`  w-full box-border p-3 border-1 border-[#0000004D] rounded-[6px] focus:ring-2 ${
                      errors[field.id]
                ...
                <div className="flex flex-col  w-full">
                  <input
                    ...
                    onChange={handleChange}
                    placeholder={field.placeholder}
                    className={`w-full p-3 border-1 border-[#0000004D] rounded-[6px] focus:ring-2 ${
                      errors[field.id]
                        ? 'border-red-500 focus:ring-red-200'
                        : 'border-gray-300 focus:ring-blue-200'
                    }`}
